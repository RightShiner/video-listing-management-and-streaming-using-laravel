               ...
               <div class="row">
                  <div class="col-lg-12">
                     <div class="osahan-form">
                        <div class="row">
                           ...
                           <div class="col-lg-12">
                              <div class="form-group">
                                 ...
                                 <input type="text" placeholder="Keywords" name="keywords" data-role="tagsinputs" id="e1" class="form-control">
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="row">
                           <div class="col-lg-4">
                              <div class="form-group">
                                 ...
                                 <select id="e3" name="category" class="custom-select form-control">
                                    ...
                                    @foreach($cat as $list)
                                    <option value="{{$list->catId}}">{{$list->category_name}}</option>
                                    @endforeach
                           ...
                           <div class="col-lg-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" id="e1" name="language" class="form-control">
                              </div>
                           </div>
                        ...
                        <div class="col-lg-12">
                              <div class="form-group">
                                 <label for="e1">Choose Video</label>
