...
<div class="" style="background:#FFF; padding: 15px; margin-top:20px;">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="{{url("/edit/video/$list->vid")}}" id="{{$list->vid}}" class="btn btn-success view">edit</a></td>
      <td><a href="{{url("/delete/video/$list->vid")}}" id="{{$list->vid}}" class="btn btn-danger band"><i class=" fa fa-trash"></i></a></td>
    </tr>
    @endforeach
  </tbody>
