                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-12">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="title" placeholder="" id="title" class="form-control" value="{{$edit->title}}">
                                 <input type="hidden" name="id" placeholder="" id="title" class="form-control" value="{{$edit->Id}}">
                              </div>
                           </div>
                           ...
                           <div class="col-lg-12">
                              <div class="form-group">
                                 ...
                                 <textarea rows="3" name="description" id="tinymce_full" class="form-control" style="height: 400px;">{!!$edit->text!!}</textarea>
                              </div>
                           </div>
